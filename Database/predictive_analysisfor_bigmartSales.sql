...
--
-- Host: localhost
-- Generation Time: Nov 05, 2021 at 06:31 AM
...
--
-- Database: `predictive_analysisfor_bigmartsales`
--
CREATE DATABASE IF NOT EXISTS `predictive_analysisfor_bigmartsales` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `predictive_analysisfor_bigmartsales`;
...
('wz8nvw9aonv58bx31niydct5h20ehfan', 'eyJ1c2VyaWQiOjI0fQ:1mhtoi:hMinbG14AVvX0j5OVLvxc-A51snuVWNldlIO5RtTyVc', '2021-11-16 13:27:08.558655'),
('xf6gq6fz6szf6nuf4pldkl528pgg4lx3', 'eyJ1c2VyaWQiOjExfQ:1mhtU6:w_C64Rx312j5F7A-qGePDM345915TMNPPr5ySe4136o', '2021-11-16 13:05:50.591021'),
...
--
-- Table structure for table `remote_user_bigmart_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_bigmart_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Item_Identifier` varchar(300) NOT NULL,
  `Outlet_Identifier` varchar(300) NOT NULL,
  `Item_Outlet_Sales` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `remote_user_detection_values_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_detection_values_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
  `MAE` varchar(300) NOT NULL,
  `MSE` varchar(300) NOT NULL,
  `RMSE` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
