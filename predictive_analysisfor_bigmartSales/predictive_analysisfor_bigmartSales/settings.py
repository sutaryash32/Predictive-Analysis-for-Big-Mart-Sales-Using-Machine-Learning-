...
ROOT_URLCONF = 'predictive_analysisfor_bigmartSales.urls'
...
WSGI_APPLICATION = 'predictive_analysisfor_bigmartSales.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'predictive_analysisfor_bigmartSales',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
